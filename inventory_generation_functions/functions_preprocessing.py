...
# (Note: this is a DIFFERENT source than rename_nsi_data26(), which expects the UPPERCASE
#  field names of the downloaded NSI geodatabase, not the lowercase API JSON.)
#
